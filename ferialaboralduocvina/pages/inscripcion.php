                      ...
                      <br>
                        <table class="table table-bordered">
                          ...
                          <tr>
                            ...
                            <td><center> <input type="radio" name="nombre" value="26"/> Ejecutivos de call center </center></td>
                          ...
                          <tr>
                            ...
                            <td><center> <input type="radio" name="nombre" value="7"/>  Operario  </center></td>
                            <td><center>PART TIME </center></td>
                          ...
                          <tr>
                            ...
                            <td><center> <input type="radio" name="nombre" value="35"/> Ejecutivo Programa Trainee </center></td>
                          ...
                          <tr>
                            ...
                            <td><center> <input type="radio" name="nombre" value="19"/> Analista Customer Success </center></td>
                            <td><center>PART TIME</center></td>
                          ...
                          <tr>
                            ...
                            <td><center> <input type="radio" name="nombre" value="20"/> ASESOR DE COMPRAS </center></td>
                            <td><center>PART TIME</center></td>
                          ...
                          <tr>
                            <td><center> <input type="radio" name="nombre" value="21"/> CAJERO </center></td>
                            <td><center>PART TIME</center></td>
                            <td><center>Encargado de atención de clientes y transacciones en el sector de cajas.</center></td>
                            <td><center>Estudiantes de cualquier área</center></td>
                          </tr>
                          <tr>
                            <td><center> <input type="radio" name="nombre" value="211"/> VENDEDOR ESPECIALISTA </center></td>
                            <td><center>PART TIME</center></td>
                          ...
                          <tr>
                            ...
                            <td><center> <input type="radio" name="nombre" value="20"/> GARZONES </center></td>
                            <td><center>PART TIME</center></td>
                            <td><center>TRABAJO EN RESTAURANTE</center></td>
                            <td><center>Estudiantes de cualquier área</center></td>
                          </tr>
                          <tr>
                            <td><center> <input type="radio" name="nombre" value="211"/> MUCAMAS </center></td>
                            <td><center>PART TIME</center></td>
                          ...
                          <tr>
                            ...
                            <td><center> <input type="radio" name="nombre" value="20"/> Vendedor, Reponedor, Cajero, Auxiliar Bodega. </center></td>
                            <td><center>PART TIME</center></td>
                          ...
                          <tr>
                            ...
                            <td><center> <input type="radio" name="nombre" value="20"/> Atencion cliente </center></td>
                            <td><center>PART TIME</center></td>
                          ...
                          <tr>
                            ...
                            <td><center> <input type="radio" name="nombre" value="20"/> Operarios </center></td>
                            <td><center>PART TIME</center></td>
                        ...
                        <br>
                          <table class="table table-bordered">
                            ...
                            <tr>
                              ...
                              <td><center> <input type="radio" name="nombre" value="27"/> Atención público </center></td>
                            ...
                            <tr>
                              <td><center> <input type="radio" name="nombre" value="28"/> Analista programador </center></td>
                            ...
                            <tr>
                              <td><center> <input type="radio" name="nombre" value="59"/> Practicante  TI</center></td>
                            ...
                            <tr>
                              <td><center> <input type="radio" name="nombre" value="48"/> Diseñador Industrial </center></td>
                              <td><center>Práctica profesional</center></td>
                            ...
                            <tr>
                              ...
                              <td><center> <input type="radio" name="nombre" value="11"/> Asistente comercial </center></td>
                              <td><center>Contrato indefinido</center></td>
                            ...
                            <tr>
                              <td><center> <input type="radio" name="nombre" value="48"/> Analista </center></td>
                              <td><center>Contrato indefinido</center></td>
                            ...
                            <tr>
                              ...
                              <td><center> <input type="radio" name="nombre" value="60"/> Encargado Administrativo </center></td>
                              <td><center>PLAZO FIJO</center></td>
                            ...
                            <tr>
                              <td><center> <input type="radio" name="nombre" value="24"/> Informatico </center></td>
                              <td><center>Contrato indefinido</center></td>
                            ...
                            <tr>
                              ...
                              <td><center> <input type="radio" name="nombre" value="31"/> Practica de auditoria </center></td>
                              <td><center>Práctica profesional</center></td>
                              <td><center>Area auditoria</center></td>
                              <td><center>Auditoría</center></td>
                            </tr>
                            <tr>
                              <td><center> <input type="radio" name="nombre" value="32"/> Practica de contabilidad </center></td>
                              <td><center>Práctica profesional</center></td>
                            ...
                            <tr>
                              ...
                              <td><center> <input type="radio" name="nombre" value="17"/> Practica en Administración de Empresas.</center></td>
                              <td><center>Práctica profesional</center></td>
                            ...
                            <tr>
                              ...
                              <td><center> <input type="radio" name="nombre" value="1"/> Jefe Customer Success </center></td>
...
Apoyo, control y definición de estrategias comerciales.</center></td>
                            ...
                            <tr>
                              <td><center> <input type="radio" name="nombre" value="2"/> Analista programador </center></td>
                              <td><center>Práctica profesional</center></td>
                            ...
                            <tr>
                              <td><center> <input type="radio" name="nombre" value="3"/> Analista programador </center></td>
                              <td><center>PART TIME Y FULLTIME</center></td>
                              <td><center>Conocimientos en javascript y nociones avanzadas de programación web</center></td>
                              <td><center>Analista Programador Computacional, Ingeniería en informatica</center></td>
                            </tr>
                            <tr>
                              <td><center> <input type="radio" name="nombre" value="4"/> Apoyo a Gerente General </center></td>
                              <td><center>Práctica profesional</center></td>
                            ...
                            <tr>
                              <td><center> <input type="radio" name="nombre" value="4"/> Analista Customer Success </center></td>
                              <td><center>Práctica profesional</center></td>
                              <td><center>Atención usuarios canal interno. 
                                          Generación de informes.
                                          Levantamiento de información.
                            ...
                            <tr>
                              ...
                              <td><center> <input type="radio" name="nombre" value="51"/> Operarios </center></td>
                              <td><center>Full time</center></td>
                            ...
                            <tr>
                              <td><center> <input type="radio" name="nombre" value="52"/> Practicante </center></td>
                              <td><center>Práctica profesional</center></td>
                            ...
                            <tr>
                              ...
                              <td><center> <input type="radio" name="nombre" value="34"/> Soporte técnico </center></td>
                              <td><center>Práctica profesional</center></td>
                            ...
                            <tr>
                              <td><center> <input type="radio" name="nombre" value="52"/> Administrador Web </center></td>
                              <td><center>Práctica profesional</center></td>
                              <td><center>Administrar pagina web, diseño imagen corporativa.</center></td>
                              <td><center>Diseño Gráfico, Publicidad.</center></td>
                            </tr>
                            <tr>
                              <td><center> <input type="radio" name="nombre" value="52"/> Atencion cliente</center></td>
                              <td><center>PLAZO FIJO</center></td>
                            ...
                            <tr>
                              <td><center> <input type="radio" name="nombre" value="52"/> Diseñadores Gráficos o Industriales</center></td>
                              <td><center>PLAZO FIJO</center></td>
                              <td><center>Diseño de piezas gráficas, prototipos funcionales, material gráfico en soportes análogos y/o digitales.</center></td>
                              <td><center>Diseño Gráfico o Industrial.</center></td>
                            </tr>
                            <tr>
                              ...
                              <td><center> <input type="radio" name="nombre" value="29"/> Operarios</center></td>
                              <td><center>FULL TIME</center></td>
                            ...
                            <tr>
                              <td><center> <input type="radio" name="nombre" value="30"/> Bodeguero </center></td>
                              <td><center>FULL TIME</center></td>
                            ...
                            <tr>
                              <td><center> <input type="radio" name="nombre" value="30"/> Ordenadora </center></td>
                              <td><center>FULL TIME</center></td>
                              <td><center>Orden de productos, </center></td>
                              <td><center>Persona con mucha energía y ganas de trabajar</center></td>
                            </tr>
                            <tr>
                              <td><center> <input type="radio" name="nombre" value="30"/> VENDEDORA </center></td>
                              <td><center>FULL TIME</center></td>
                            ...
                            <tr>
                              ...
                              <td><center> <input type="radio" name="nombre" value="5"/> Vendedor </center></td>
                              <td><center>FULL TIME</center></td>
                            ...
                            <tr>
                              <td><center> <input type="radio" name="nombre" value="6"/> Cajero </center></td>
                              <td><center>FULL TIME</center></td>
                            ...
                            <tr>
                              ...
                              <td><center> <input type="radio" name="nombre" value="37"/> Analista/ Desarrollador  </center></td>
                              <td><center>FULL TIME</center></td>
                            ...
                            <tr>
                              <td><center> <input type="radio" name="nombre" value="38"/> Administrador de Sistemas </center></td>
                              <td><center>FULL TIME</center></td>
                            ...
                            <tr>
                              <td><center> <input type="radio" name="nombre" value="39"/> Quality Assurance</center></td>
                              <td><center>FULL TIME</center></td>
                            ...
                            <tr>
                              ...
                              <td><center> <input type="radio" name="nombre" value="56"/> Practicante en área Publicidad.</center></td>
                              <td><center>Práctica profesional</center></td>
                            ...
                            <tr>
                              <td><center> <input type="radio" name="nombre" value="57"/> Practicante Administración de Redes.  </center></td>
                              <td><center>Práctica profesional</center></td>
                            ...
                            <tr>
                              <td><center> <input type="radio" name="nombre" value="58"/> Practicante apoyo área Visual. </center></td>
                              <td><center>Práctica profesional</center></td>
                            ...
                            <tr>
                              <td><center> <input type="radio" name="nombre" value="58"/> Practicante de apoyo en área de Recursos Humanos.</center></td>
                              <td><center>Práctica profesional</center></td>
                            ...
                            <tr>
                              ...
                              <td><center> <input type="radio" name="nombre" value="54"/> Practicante en área administrativa. </center></td>
                              <td><center>Práctica profesional</center></td>
